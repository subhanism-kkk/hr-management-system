...
public final class PersonSpecification {
    ...
    public static Specification<Person> hasStatusCode(String statusCode) {
    ...
    public static Specification<Person> createdFrom(LocalDateTime from) {
        if (from == null) {
            return null;
        }
    ...
    public static Specification<Person> createdTo(LocalDateTime to) {
        if (to == null) {
            return null;
        }
    ...
    public static Specification<Person> build(PersonSearchCriteria criteria) {
        if (criteria == null) {
